...
12.10.2.1 - This is a common "gotcha" clause in ASCE 7-16 that is also incredibly confusing. Essentially, collectors and their connections should be designed to "omega-level" force, which may not always be as simple as multiplying demand by omega. The omega-level force is defined as the minimum of:
...
4.3.4.1 - Shear walls have limiting aspect ratios:
...
Using the above derivation and assumptions, we create a handy table to quickly look up wall stiffness:
